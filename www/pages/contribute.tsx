      ...
      <ContributePaperComponent elevation={1} style={{ border: '1px solid black' }}>
        ...
        <Box
          ...
          <TypographyComponent variant='subtitle2' style={{ marginBottom: '-32px' }}>
            Our serves as a guide to help all of us and the technical communities in which we engage grow.
          </TypographyComponent>
          <TypographyComponent variant='subtitle2'>
            <ul style={{ margin: 0 }}>
              <li>
                <ATagComponent
                  href='https://github.com/ConduitPlatform/Conduit/blob/master/.github/CODE_OF_CONDUCT.md'>
                  Conduit
                </ATagComponent>
              </li>
              <li>
                <ATagComponent
                  href='https://github.com/ConduitPlatform/Conduit-UI/blob/master/.github/CODE_OF_CONDUCT.md'>
                  Conduit-UI
                </ATagComponent>
              </li>
            </ul>
          ...
          <TypographyComponent variant='subtitle2' style={{ marginBottom: '-32px' }}>
            There are guidelines for contributing, just as there are for every project.
            Please read the contributing guide to ensure that we are able to assist you or
            approve your pull request as soon as possible.
          </TypographyComponent>
          <TypographyComponent variant='subtitle2'>
            <ul style={{ margin: 0 }}>
              <li>
          ...
          <TypographyComponent variant='h5' style={{ marginBottom: '-24px' }}>Join us on social
            platforms!</TypographyComponent>
          <TypographyComponent variant='subtitle2'>
            <ul style={{ margin: 0 }}>
              <li>Matrix</li>
              <li>Discord</li>
