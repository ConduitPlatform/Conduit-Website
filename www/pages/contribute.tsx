        ...
        <ContributePaperComponent elevation={1} style={{ border: '1px solid black' }}>
          ...
          <Box
            ...
            <TypographyComponent variant="subtitle2" style={{ marginBottom: '-32px' }}>
              Our code of conduct serves as a guide to help all of us and the technical communities
              in which we engage grow.
            </TypographyComponent>
            <TypographyComponent variant="subtitle2">
              <ul style={{ margin: 0 }}>
                <li>
            ...
            <TypographyComponent variant="subtitle2" style={{ marginBottom: '-32px' }}>
              There are guidelines for contributing, just as there are for every project. Please
              read the contributing guide to ensure that we are able to assist you or approve your
