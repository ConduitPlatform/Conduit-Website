...
<BlogHighlighter language={'typescript'}>
...
<SectionItemComponent topic='What is the impact of human errors?'>
<p>
...
<SectionItemComponent topic='Will it be fixed when Homo Sapiens stable is released?'>
