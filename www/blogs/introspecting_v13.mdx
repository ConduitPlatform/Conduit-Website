...
Tldr; We added support for database introspection and API client library generation, revamped service discovery, 
...
<p>
  We took a first step towards revamping our service discovery for modules. This is just a first step with way more stability improvements already in queue for upcoming versions.
</p>
<p>
...
<p>
  This release introduces REST/GraphQL API client library generation through our CLI (releasing soon).
</p>
<p>
...
<p>
  Security clients may now include aliases and notes.
</p>
<p>
...
<p>
  We implemented the [gRPC health check protocol](https://github.com/grpc/grpc/blob/master/doc/health-checking.md), meaning you may now find out a module's serving status and even subscribe to updates regarding its health state.
</p>
<p>
