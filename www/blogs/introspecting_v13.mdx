...
<p>
  We intend to natively package and release it on multiple repos down the line, but for the time being you can <a href="https://www.npmjs.com/package/@conduitplatform/cli">grab it from npm</a> or <a href="https://github.com/ConduitPlatform/CLI">build it yourself</a>.
</p>
