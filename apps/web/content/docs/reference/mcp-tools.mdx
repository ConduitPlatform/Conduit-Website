...
| `POST /embeddings/search` | `post_embeddings_search` |

Full embeddings Admin/MCP inventory (12 route tools plus `get_config_embeddings` / `patch_config_embeddings`) is on the [Embeddings](/docs/modules/embeddings) module page.
