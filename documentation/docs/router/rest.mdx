...
We pass it along as the Authentication header, prefixed by `Bearer `.<br />
...
Lets send one last admin request to create an Android security client.<br />
You're going to need one of these in order to perform your application requests.
...
<!-- TODO:
Alright, stick with me now. Small talk is over.<br />
