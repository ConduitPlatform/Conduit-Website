...
In order for your users to perform user authenticated application requests you'll need to pass their `accessToken` as an [authorization header](../../../router/headers#headers-app-auth).<br />
...
**User access and refresh tokens are tied to the security client they were generated with, meaning you can't use or refresh them using a different security client id/secret pair**.
