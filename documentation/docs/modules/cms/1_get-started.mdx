...
Using the CMS requires that you already have a basic understanding of how Conduit functions.<br />
...
```jsx
CONDUIT_SERVER=0.0.0.0:55152 SERVICE_IP=0.0.0.0:56154 npx @conduit/cms start
```

At this point, you should have a functional CMS instance.<br />
You may now register and manipulate custom content through the [Admin Panel] (TODO).

-------------------------------------------------

## Using the Admin Panel

Lets walk you through some examples on how to utilize the CMS module through Conduit's admin panel.
Start by, [launching the admin panel] (TODO) and navigating to the CMS page.

![Schema View](/img/modules/cms/admin/schema_list_view.png)
...
![Schema Edit View Empty](/img/modules/cms/admin/schema_edit_view_empty.png)
...
![Schema Field Edit Text](/img/modules/cms/admin/schema_field_edit_text.png)
...
![Schema Field Edit Enum](/img/modules/cms/admin/schema_field_edit_enum.png)
...
![Schema Edit View Filled](/img/modules/cms/admin/schema_edit_view_filled.png)
...
[REST](#rest-example) API endpoints and GraphQl interface 
...
Open the `Schema Data` tab in the CMS page of our admin panel.

![Document Manipulation View Empty](/img/modules/cms/admin/document_manipulation_view.png)

This is the document manipulation view, where you can create, update and delete data for any of your schemas.
...
![Document Creation Popup](/img/modules/cms/admin/document_creation_popup.png)
...
![Document View Modes](/img/modules/cms/admin/document_view_modes.png)
...
Before we move on to custom endpoints, you might wish to check out the introduction to 
the [REST API](#rest-example) so that you have a better understanding of endpoints.
...
Looking for additional examples on how to use the CMS module?<br />
