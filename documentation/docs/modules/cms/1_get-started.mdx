...
[REST](../../core/router/1_rest.mdx) and [GraphQl](../../core/router/2_graphql.mdx) API endpoints 
...
This section requires a fundamental understanding of how to use Conduit's [REST](../../core/router/1_rest.mdx) 
or [GraphQl](../../core/router/2_graphql.mdx) powered APIs.<br />
