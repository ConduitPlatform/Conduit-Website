...
This tutorial makes use of [Conduit's REST API] (TODO) for CRUD operations.

### Prerequisites

Following this tutorial requires that you have already read the CMS module's 
[Getting Started](../1_get-started.mdx) guide.<br />
...
![Movies Schema Created](/img/modules/cms/tutorials/cinema_tickets_booking/movies_schema_created.png)
...
![Halls Class Enum](/img/modules/cms/tutorials/cinema_tickets_booking/halls_class_enum.png)
...
![Projections Movie Relation](/img/modules/cms/tutorials/cinema_tickets_booking/projections_movie_relation.png)
...
Yeap. Your schemas are already exposed through [Conduit's REST API] (TODO).<br />
