...
<Tabs>
  ...
  DB_URL="mongodb://conduit-mongo:27017" make start-database
  ```
  </TabItem>
...
:::
  ...
  ``` bash
  DB_TYPE="sql" -e DB_URL="postgres://conduit:pass@localhost:5432/conduit" \
  make start-database
  ```
  </TabItem>
  </Tabs>
...
:::
  ...
  docker run -d --name conduit-database \
                ...
                -e REGISTER_NAME="true" -e CONDUIT_SERVER="conduit-core:55152" \
                -e databaseType="sql" \
                -e databaseURL="postgres://conduit:pass@localhost:5432/conduit" \
                ghcr.io/conduitplatform/database:latest
  ```
  </TabItem>
  </Tabs>
