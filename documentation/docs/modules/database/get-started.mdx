...
[REST](../../router/rest.mdx) and [GraphQL](../../router/graphql.mdx) API endpoints 
...
This section requires a fundamental understanding of how to use Conduit's [REST](../../router/rest.mdx) 
or [GraphQL](../../router/graphql.mdx) powered APIs.<br />
