...
![Introspection View](/img/modules/database/admin/introspection_view.png)
...
![Introspection Schema View](/img/modules/database/admin/introspection_schema_view.png)
### Editing Schemas

> For a detailed guide on how the Schema Editor works, checkout our [Get Started Guide](https://getconduit.dev/docs/modules/database/get-started).
...
![Introspection New Field](/img/modules/database/admin/introspection_new_field.png)
...
![Introspection Edit Field](/img/modules/database/admin/introspection_edit_field.png)
