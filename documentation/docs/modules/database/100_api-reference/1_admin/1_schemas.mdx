...
```json title="POST on /admin/database/schemas"
{
  "name": "citizens",
  "fields": {
...
|   Route                     | Method  |
| :-------------------------: | :-----: |
| /admin/database/schemas/:id |  PATCH  |

Patch a schema by id.
...
|   Route                     |  Method  |
| :-------------------------: | :------: |
| /admin/database/schemas/:id |  DELETE  |
...
|   Route                            | Method |
| :--------------------------------: | :----: |
| /admin/database/schemas/:id/toggle |  POST  |

Toggle the 'enabled' state of a schema by id.
...
|   Route                        | Method |
| :----------------------------: | :----: |
| /admin/database/schemas/toggle |  POST  |

Toggle the 'enabled' state of schemas.
...
|   Route                                 | Method  |
| :-------------------------------------: | :-----: |
| /admin/database/schemas/:id/permissions |  PATCH  |

Set a schema's permissions by id.
