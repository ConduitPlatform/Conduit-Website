...
In the previous tutorial we learned how to create a schema.It is important also to learn<br />
how to create a custom CRUD operation and attach it to a custom endpoint.<br />

## Create an Endpoint

Let's navigate to the Admin Panel in the `database/custom` section.

![custom enpoints panel](/img/first_app/custom_endpoints_panel.png)
...
![custom enpoints panel](/img/first_app/SomeEndpoint.png)
...
![Add Input](/img/first_app/add_input.png)
...
![Add Query](/img/first_app/add_condition.png)
