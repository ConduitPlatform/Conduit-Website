...
```jsx
CONDUIT_SERVER=0.0.0.0:55152 SERVICE_IP=0.0.0.0:56154 npx @conduit/storage start
```

**Notice:** This module is disabled by default as it requires initial configuration.<br />
Selecting **[Local](config.mdx/#local-storage) storage as your provider is the fastest way to get started.
