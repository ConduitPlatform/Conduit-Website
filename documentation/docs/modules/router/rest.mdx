...
Make sure you pass in the [`masterkey` header](headers#headers-masterkey) along with your administrator credentials and send your data as raw JSON.<br />
...
<details>
  ...
  These ones require a set of <a href="./headers/#headers-security">application headers</a> to be passed along.<br /><br />

  A <a href="./headers/#headers-app">security client id and secret pair</a> to be precise.<br />
  User authenticated routes additionally require an <a href="./headers/#headers-auth">Authorization header</a> containing a user authentication bearer token.<br />
