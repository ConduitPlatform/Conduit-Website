...
![Send an email](/img/email/send_email.png)
...
![Create template with variables](/img/email/variables.png)
...
![Send an email with variables](/img/email/send_variable_email.png)
...
![Import template](/img/email/import_template.png)
