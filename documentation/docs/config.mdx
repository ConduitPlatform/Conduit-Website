...
Modules can be configured through the [Admin Panel](admin-panel.mdx) or using [Conduit's REST API](router/1_rest.mdx).<br />
...
Every configurable module has a configuration section in the [Admin Panel](admin-panel.mdx).<br/>
