...
To keep this section concise and cross-platform, we're going to install Conduit's CLI through npm, but you may make use of the [supported installation methods](cli/) you deem preferable.
