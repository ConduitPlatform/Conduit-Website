...
OR just create whatever you like and remember to read the [docs](../modules/modules.mdx) :D

You can also ask questions [here](https://github.com/ConduitPlatform/Conduit/issues/new/choose) and say hi [here](https://getconduit.dev/contribute)
