...
![Schema List View](/img/modules/database/admin/schema_list_view.png)
...
![Schema CRUD Options Configuration](/img/first_app/schema_crud_configuration.png)
...
![Registration Component](/img/first_app/registration_component.png)
...
![Create Movie](/img/first_app/create_movie_component.png)
...
![List Movies Before](/img/first_app/list_movies_component_before.png)

Navigate to [`/movies`](http://localhost:3050/movies) and click on the `GET MOVIES` button.<br />

![List Movies After](/img/first_app/list_movies_component_after.png)
