...
Once you have taken the Bearer Token you are ready to make requests.In order to understand how to make requests using a React
I will give an example of how to do this.<br />
Let's make a React component which is responsible for Schema creation.<br />
The route which is responsible for Chat Creation is mapped to `CONDUIT_URL/chat/new` path.<br />
See more about Chat Room creation [here](../modules/chat/api-reference/user)
...
Navigate to `http://localhost:PORT/movie` and fill the displayed inputs and press the submit button.<br />
...
Now you are ready to retrieve the movies.Navigate to the `localhost:PORT/movies` and click the **GET MOVIES** button.<br />
