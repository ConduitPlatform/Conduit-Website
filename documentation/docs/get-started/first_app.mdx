...
An example of how to do this will be given.<br />
...
To create a schema you should have admin privileges.<br />
...
In order to understand how a client uses the Conduit Service we are going to create a Movie Document!<br />
