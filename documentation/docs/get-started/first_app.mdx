...
<!-- TODO: Route paths should ideally be altered (currently: login, movie, movies -> login, submit-movie, retrieve-movies or sth -->
...
Our application is going to be sending application requests to our backend.<br />
Said requests are going to require [Application Headers](../router/headers#headers-app).<br />
Make sure you've [generated a Security Client](../router/headers#headers-app-security) and obtained the relevant client id and secret to be used in our requests.

<!-- TODO: Example application should handle user creation too -->

<details><summary>Creating our first User</summary>

We'll create a new user specifying their `email` address and `password`.
...
async function loginUser(credentials) {
  return fetch('http://localhost:PORT/authentication/local', {
    ...
    headers: {
      ...
      // highlight-start
      'clientid': 'YOUR_SECURITY_CLIENT_ID',          // eg: 1c0d06679f837c3958fba2724b51dc
      'clientsecret': 'YOUR_SECURITY_CLIENT_SECRET',  // eg: 9ffd3a9041bff6aabff5fa81df8175c2406baaca6c417a165f5b66a9ad1c1e4408bc4aad895126ddc0ee007332aacf842f63ebc68eddc304a902a3f8867e9902
      // highlight-end
    },
...
The server's response contains our user's id, as well as a pair of access and refresh tokens to be used in our user authenticated application routes.<br />
...
Check out this [tutorial](../modules/database/tutorials/cinema_ticket_booking#movies_schema) on how to create a schema through the Admin Panel.<br />
