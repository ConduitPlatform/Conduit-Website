...
Enable the [Magic Link](./strategies#magic-link) authentication strategy and specify the redirect URi to which the user will be redirected after signing in.
