...
As in dev using the sdk you have the option to decide whenever a user will be verified or not.<br />
You can enable also sign up verification by sending an email.
