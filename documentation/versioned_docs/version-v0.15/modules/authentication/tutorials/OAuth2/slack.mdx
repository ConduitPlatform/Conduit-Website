...
To create a Slack App, go to [Slack](https://api.slack.com/apps) and click on the **Create New App** button.
...
***NOTE***<br />
**Do not forget to configure the Slack provider through the [Admin Panel](../../config#third-party-providers).**<br />
