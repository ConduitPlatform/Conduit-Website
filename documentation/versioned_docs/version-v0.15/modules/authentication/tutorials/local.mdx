...
The Authentication module comes with JWT functionality built in.<br />
JWTs are a great way to authenticate users without having to store any session data on the server.<br />
This is especially useful for mobile applications, where you don't want to have to worry about managing sessions.<br />
JWTs are also a great way to authenticate users for API requests.
