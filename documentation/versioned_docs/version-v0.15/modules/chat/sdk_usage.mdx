...
There are some questions that we need to answer before taking a decision to implement the update functionality.

- Who is going to update the chat room?
- Does the user is authorized to do it?

All these obstacles can be overcome by creating an authorization module.
Authorization module is in the pipeline and will be available soon.
