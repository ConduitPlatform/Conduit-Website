...
![Send an email](/v0.15/modules/email/admin/send_email.png)
...
![Create template with variables](/v0.15/modules/email/admin/variables.png)

All you have to do is to select your template while sending an email.

![Send an email with variables](/v0.15/modules/email/admin/send_variable_email.png)
...
![Import Email Template](/v0.15/modules/email/admin/import_template.png)
