...
| [**lt**](./operators#lt)              | Selects the documents where the value of the field is less than (i.e. <) the specified value.                            |
| [**gt**](./operators#gt)              | Selects the documents where the value of the field is greater than (i.e. >) the specified value.                         |
| [**lte**](./operators#lte)            | Selects the documents where the value of the field is less or equal than (i.e. <=) the specified value.                  |
| [**gte**](./operators#gte)            | Selects the documents where the value of the field is greater or equal than (i.e. >=) the specified value.               |
