...
![Create container](/v0.15/modules/storage/admin/create_container.png)
...
![Create Folder](/v0.15/modules/storage/admin/create_folder.png)
...
![Create File Empty](/v0.15/modules/storage/admin/create_file_empty.png)

Click on `Add` and specify your file's details.<br />

![Create File Filled](/v0.15/modules/storage/admin/create_file_filled.png)
