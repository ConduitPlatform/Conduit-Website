...
<details>
  ...
  Out of the box, Conduit's Authentication module utilizes <a href="../authentication/strategies/strategies#local">Local Authentication</a> in order to provide you with a simple,
