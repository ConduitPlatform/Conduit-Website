...
The [Authentication](../authentication) module provides multiple [authentication strategies](../authentication/Login-Methods/strategies) for you to choose from.<br />
...
<details>
  ...
  Out of the box, Conduit's Authentication module utilizes <a href="../authentication/Login-Methods/strategies#local">Local Authentication</a> in order to provide you with a simple,
