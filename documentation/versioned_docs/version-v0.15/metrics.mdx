...
Conduit's [Admin Panel](./administration/admin-panel.mdx) displays metric information through numerous
...
In order for the [Admin Panel](./administration/admin-panel.mdx) to display metrics-related information
