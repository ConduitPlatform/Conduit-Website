...
![Config Example View](/v0.15/config/admin/config_ex_view.png)

What? No XXL pizzas and pineap... This is clearly a mistake.<br />
Edit this 🍍 monstrosity out of existence!

![Config Example Edit](/v0.15/config/admin/config_ex_edit.png)

Quick, save your configuration before the heathens get a grip of what's going on!

![Config Example Success](/v0.15/config/admin/config_ex_success.png)
