...
The following example makes use of `npm`.<br />
If you'd rather not install `node` or go through `npm` you may still [use the CLI through a native package option](./cli#installation-methods).
