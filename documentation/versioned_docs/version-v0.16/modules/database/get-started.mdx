...
![Schema View](/v0.16/modules/database/admin/schema_list_view.png)
...
![Schema Edit View](/v0.16/modules/database/admin/schema_edit_view.png)
...
![Schema Field Edit Text](/v0.16/modules/database/admin/schema_field_edit_text.png)
...
![Schema Field Edit Enum](/v0.16/modules/database/admin/schema_field_edit_enum.png)
...
![Document Manipulation View Empty](/v0.16/modules/database/admin/document_manipulation_view.png)
...
![Document Creation Popup](/v0.16/modules/database/admin/document_creation_popup.png)
...
{/* TODO: Add Document Data Registered screenshot */}
...
![Document View Modes](/v0.16/modules/database/admin/document_view_modes.png)
...
{/* TODO: Add Document JSON Editor screenshot */}

Pretty cool, right? No? Oh well, guess that's just me.

{/* TODO: Custom Endpoints example section */}

{/* TODO: Data Access and Manipulation examples section */}
...
Check out the available [tutorials](./tutorials/cinema-booking)!
