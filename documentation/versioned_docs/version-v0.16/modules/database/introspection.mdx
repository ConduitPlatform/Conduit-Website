...
![Introspection View](/v0.16/modules/database/admin/introspection_view.png)
...
![Introspection Schema View](/v0.16/modules/database/admin/introspection_schema_view.png)
### Editing Schemas
...
![Introspection New Field](/v0.16/modules/database/admin/introspection_new_field.png)
...
![Introspection Edit Field](/v0.16/modules/database/admin/introspection_edit_field.png)
