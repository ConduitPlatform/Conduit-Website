...
![Custom Endpoints Panel](/v0.16/first_app/custom_endpoints_panel.png)
...
![Custom Endpoints Panel](/v0.16/first_app/SomeEndpoint.png)
...
![Add Input](/v0.16/first_app/add_input.png)
...
![Add Query](/v0.16/first_app/add_condition.png)
