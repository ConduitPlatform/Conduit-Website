...
{/* TODO: Implemented Operations section */}

## Supported Operators

|  Operator                           | Description                                                                                                              |
| :---------------------------------: | :----------------------------------------------------------------------------------------------------------------------- |
| [**in**](./operators#in)              | Matches any of the values specified in an array                                                                          |
| [**contains**](./operators#contains)  | Checks if a value is contained in an array or not.                                                                       |
| [**nin**](./operators/#nin)           | Selects the documents where the value of a field is not equal any value in the specified array.                          |
| [**eq**](./operators#eq)              | Matches documents where the value of a field equals the specified value.                                                 |
| [**ne**](./operators#ne)              | Selects the documents where the value of the field is not equal to the specified value                                   |
| [**lt**](./operators#lt)              | Selects the documents where the value of the field is less than the specified value.                            |
| [**gt**](./operators#gt)              | Selects the documents where the value of the field is greater than the specified value.                         |
| [**lte**](./operators#lte)            | Selects the documents where the value of the field is less than or equal to the specified value.                  |
| [**gte**](./operators#gte)            | Selects the documents where the value of the field is greater than or equal to the specified value.               |
| [**or**](./operators#or)              | Performs OR operation on an array of two or more expressions and selects the documents that satisfy at least one         |
| [**and**](./operators#and)            | Performs AND operation on an array of two or more expressions and selects the documents that satisfy at least one        |
| [**not**](./operators#not)            | Performs NOT operation on an array of two or more expressions and selects the documents that do not match the expression |
| [**regex**](./operators#regex)        | Select the documents where the value of the field matches the regex.                                                     |
