...
![Configuration View](/v0.16/modules/chat/chat_tutorial_1.png)
...
![Web Socket Request Headers](/v0.16/modules/chat/web_socket_headers.png)
...
![Web Socket handshake path](/v0.16/modules/chat/web_socket_settings.png)
...
![Chat Message](/v0.16/modules/chat/web_socket_message.png)
...
![Admin Panel message](/v0.16/modules/chat/final_message.png)
