...
![Enable sign-in method](/v0.16/modules/authentication/admin/auth_config.png)
...
Enabling automatic email verification deliveries for the [Local Authentication](./tutorials/Local) relies on the [Email](../email)
...
![Enable sign-in method](/v0.16/modules/authentication/tutorials/enable-2-fa.png)
...
![Third party Configuration](/v0.16/modules/authentication/admin/facebook_enable.png)
