...
![Google Type Credentials](/v0.16/modules/authentication/tutorials/google_credentials_type.png)
...
![Google Authorized Uri](/v0.16/modules/authentication/tutorials/google_redirect_uri.png)
