...
![Schema List View](/v0.16/modules/database/admin/schema_list_view.png)
...
![Schema CRUD Options Configuration](/v0.16/first_app/schema_crud_configuration.png)
...
![Registration Component](/v0.16/first_app/registration_component.png)
...
![Login Component](/v0.16/first_app/login_component.png)
...
![Create Movie](/v0.16/first_app/create_movie_component.png)
...
![List Movies Before](/v0.16/first_app/list_movies_component_before.png)

Navigate to [`/movies`](http://localhost:3050/movies) and click on the `GET MOVIES` button.<br />

![List Movies After](/v0.16/first_app/list_movies_component_after.png)
