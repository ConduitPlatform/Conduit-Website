...
![Schema View](/v0.14/modules/database/admin/schema_list_view.png)
...
![Schema Edit View](/v0.14/modules/database/admin/schema_edit_view.png)
...
![Schema Field Edit Text](/v0.14/modules/database/admin/schema_field_edit_text.png)
...
![Schema Field Edit Enum](/v0.14/modules/database/admin/schema_field_edit_enum.png)
...
![Document Manipulation View Empty](/v0.14/modules/database/admin/document_manipulation_view.png)
...
![Document Creation Popup](/v0.14/modules/database/admin/document_creation_popup.png)
...
![Document View Modes](/v0.14/modules/database/admin/document_view_modes.png)
