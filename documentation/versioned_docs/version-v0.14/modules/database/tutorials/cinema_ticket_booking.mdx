...
![Movies Schema Created](/v0.14/modules/database/tutorials/cinema_tickets_booking/movies_schema_created.png)

<div style={{textAlign: 'center'}}>

![CRUD Operations Configuration](/v0.14/modules/database/admin/schema_edit_crud.png)
...
![Halls Class Enum](/v0.14/modules/database/tutorials/cinema_tickets_booking/halls_class_enum.png)
...
![Projections Movie Relation](/v0.14/modules/database/tutorials/cinema_tickets_booking/projections_movie_relation.png)
