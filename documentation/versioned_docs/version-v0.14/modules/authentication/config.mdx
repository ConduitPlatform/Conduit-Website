...
![Enable sign-in method](/v0.14/modules/authentication/admin/auth_config.png)
...
![Enable sign-in method](/v0.14/modules/authentication/admin/enable_sign_in_method.png)
...
![Enable sign-in methods](/v0.14/modules/authentication/admin/enable2FA.png)
...
![Third party Configuration](/v0.14/modules/authentication/admin/facebook_enable.png)
