...
<i><p>
    Note: The following drawings were made by talented chipmunks, implanted with highly advanced neural chips. You may
    notice
...
<ImageSwitcher
lightImageSrc="/v0.14/overview/architecture/core_architecture.light.png"
darkImageSrc="/v0.14/overview/architecture/core_architecture.dark.png"
...
<ImageSwitcher
lightImageSrc="/v0.14/overview/architecture/general_architecture.light.png"
darkImageSrc="/v0.14/overview/architecture/general_architecture.dark.png"
